        ...
        try {
            ...
            const session = await genAI.live.connect({
                ...
                config: {
                    ...
                    systemInstruction: `You are VivaBot, the intelligent voice of "VivaBot Technologies," a pioneering AI startup from Kota, Rajasthan, founded by Yash Nagar, and Jivan who is a Marketing expert.
...
REMEMBER: NEVER use pure English. ALWAYS use Hinglish. Focus on the VISION and TECHNOLOGY, not just offering services.`
                },
                callbacks: {
                    onopen: () => {
